    ...
    <div class="relative h-full bg-slate-900 p-4 pb-6 rounded-[inherit] z-20 overflow-hidden">
      ...
      <div class="flex flex-col h-full items-center text-center ">
        <div class="relative inline-flex mb-2">
          <div
            class="w-[70%] h-[60%] absolute inset-0 m-auto -translate-y-[10%] blur-3xl -z-10 rounded-full bg-indigo-600"
            aria-hidden="true"
          ></div>
          <img
            class="inline-flex rounded-md hover:scale-105 transition-all duration-500 cursor-pointer "
            src={props.img}
            width="300"
            height="200"
            alt="Card 01"
        ...
        <div class="grow mb-5">
          <h2 class="text-xl text-slate-200 font-bold mb-">
